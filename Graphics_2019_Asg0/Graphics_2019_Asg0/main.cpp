...
//variable for changing the teapot color
int random_color;
//varible for changing the first value of the position (HORIZONTAL)
float first;
//varible for changing the second value of the position (VERTICAL)
float second;
...
void drawScene(void)
{
    ...
    glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, diffColors[random_color]);
